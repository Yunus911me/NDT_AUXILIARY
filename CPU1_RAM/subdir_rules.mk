...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ti-cgt-c2000_22.6.0.LTS/bin/cl2000" -v28 -ml -mt --float_support=fpu32 --idiv_support=idiv0 --tmu_support=tmu0 -Ooff --include_path="C:/Users/ahmad/workspace_ccstheia/NDT_AUXILIARY" --include_path="C:/Users/ahmad/workspace_ccstheia/NDT_AUXILIARY/device" --include_path="C:/ti/C2000Ware_26_01_00_00/driverlib/f28002x/driverlib/" --include_path="C:/ti/ti-cgt-c2000_22.6.0.LTS/include" --define=DEBUG --define=RAM --c99 --diag_suppress=10063 --diag_warning=225 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" --include_path="C:/Users/ahmad/workspace_ccstheia/NDT_AUXILIARY/CPU1_RAM/syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-1431934398: ../ndt_board.syscfg
	@echo 'SysConfig - building file: "$<"'
	"C:/ti/ccs2100/ccs/utils/sysconfig_1.28.0/sysconfig_cli.bat" -s "C:/ti/C2000Ware_26_01_00_00/.metadata/sdk.json" -d "F28002x" -p "80QFP" -r "F28002x_80QFP" --script "C:/Users/ahmad/workspace_ccstheia/NDT_AUXILIARY/ndt_board.syscfg" -o "syscfg" --compiler ccs
	@echo 'Finished building: "$<"'
	@echo ' '
